...
import logoFull from '../assets/Realestate.png'
...
const Sidebar = () => {
  const styles = {
    ...
    RealEstateLogo: `mr-4 flex object-cover`,
  ...
  return (
    <div className={styles.container}>
        ...
        <Link href='/'>
          <div className={styles.menuItem}>
            <Image
              ...
              height={30}
              width={30}
              className={styles.RealEstateLogo}
            />
            My Real Estate
            <br /> Board
          </div>
      ...
      <div className={styles.companyName}>
        <Image src={logoFull} alt='real estate' height={100} width={100} />
      </div>
    </div>
  )
}
